...
const int Camera::GetViewHeight()
{
	return this->_viewHeight;
}

const int Camera::GetViewWidth()
{
...
void Camera::SetXRotation(float value)
{
	this->x_rotation = value;
}

void Camera::SetYRotation(float value)
{
	this->y_rotation = value;
}

void Camera::SetZRotation(float value)
{
...
void Camera::SetViewHeight(int value)
{
	this->_viewHeight = value;
}

void Camera::SetViewWidth(int value)
{
